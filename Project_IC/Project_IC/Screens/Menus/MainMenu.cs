...
namespace Project_IC.Screens.Menus {
	class MainMenu : MenuScreen {
		...
		protected override void SetGui() {
			...
			GuiTestButton = new Button(100, 30, 0, "Gui Test");
			GuiTestButton.LeftClicked += (s, e) => ScreenManager.AddScreen(new GuiTestScreen());

			Gui.BaseScreen.AddControls(Title, SinglePlayerButton, MultiPlayerButton, OptionsButton, AchievementsButton, QuitButton, TestScreenButton, GuiTestButton);
